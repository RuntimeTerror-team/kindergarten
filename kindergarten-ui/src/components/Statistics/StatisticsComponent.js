...
const StatisticsComponent = ({ firstPlace, secondPlace, thirdPlace, fourthPlace, fifthPlace, fromEndFirstPlace, fromEndSecondPlace,
    ...
    return (
        <div>
            <div className=" col-12 my-4 mx-0">
                <h3 className="mb-3">Populiariausių darželių Top 5</h3>
                <div className="templatemo-content-widget no-padding m-0">
                    <div className="panel panel-default table-responsive">
                        <table className="table table-striped table-bordered templatemo-user-table fixedTable">
                            <thead>
                                <tr>
            ...
            <div className=" col-6 my-4 mx-0">
                <h3 className="mb-3">Prašymų statistika</h3>
                <div className="templatemo-content-widget no-padding mx-0 mb-5">
                    <div className="panel panel-default table-responsive">
