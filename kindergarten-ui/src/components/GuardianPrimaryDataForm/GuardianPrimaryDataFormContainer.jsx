...
class GuardianPrimaryDataFormContainer extends Component {
  ...
  savePerson = (e) => {
    if (
      ...
      this.state.personalCodeValidation === "" &&
      this.state.personalCode.trim().length !== 0 &&
      this.state.addressValidation === "" &&
      this.state.address.trim().length !== 0 &&
      this.state.cityValidation === "" &&
      this.state.city.trim().length !== 0 &&
      this.state.postalCodeValidation === "" &&
      this.state.postalCode.trim().length !== 0 &&
      this.state.phoneNoValidation === "" &&
      this.state.phoneNo.trim().length !== 0 &&
      ...
      <div className="templatemo-flex-row">
        ...
        <div className="templatemo-content light-gray-bg col px-0">
          ...
          <div className="templatemo-content-container">
            <h1 className="mb-5 text-center page-name">
              <strong>Pirminių duomenų anketa</strong>
            </h1>
